...
public final class SimpleServiceServer implements io.rsocket.RSocket {
  ...
  public reactor.core.publisher.Mono<io.rsocket.Payload> requestResponse(io.rsocket.Payload payload) {
    try {
      ...
      switch(io.netifi.proteus.frames.RoutingFlyweight.methodId(metadata)) {
  ...
  public reactor.core.publisher.Flux<io.rsocket.Payload> requestChannel(org.reactivestreams.Publisher<io.rsocket.Payload> payloads) {
    final reactor.core.publisher.Flux<io.rsocket.Payload> publisher = reactor.core.publisher.Flux.from(payloads);
    return publisher.next().flatMapMany(new java.util.function.Function<io.rsocket.Payload, org.reactivestreams.Publisher<? extends com.google.protobuf.MessageLite>>() {
      @java.lang.Override
