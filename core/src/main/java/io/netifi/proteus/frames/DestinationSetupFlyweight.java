...
public class DestinationSetupFlyweight {
  ...
  public static int computeLength(boolean encrypted, CharSequence destination, CharSequence group) {
  ...
  public static int encode(
    ...
    int offset =
        FrameHeaderFlyweight.encodeFrameHeader(
            byteBuf, FrameType.DESTINATION_SETUP, encrypted ? FrameHeaderFlyweight.ENCRYPTED : 0, seqId);
