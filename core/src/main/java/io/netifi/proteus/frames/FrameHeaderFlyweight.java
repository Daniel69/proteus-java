...
public class FrameHeaderFlyweight {
  ...
  // Flag Fields masks
  static final int USER_DATA_PRESENT = 0x80; //0b1000_0000;
  static final int METADATA_PRESENT  = 0x40; //0b0100_0000;
  static final int ENCRYPTED         = 0x20; //0b0010_0000;
  static final int BROADCAST         = 0x10; //0b0001_0000;
  static final int API_CALL          = 0x08; //0b0000_1000;
  static final int TOKEN             = 0x04; //0b0000_0100;
  // Frame Header field masks
  private static final int FRAME_TYPE_MASK    = 0x7F000000; //0b0111_1111_0000_0000_0000_0000_0000_0000;
  private static final int FLAGS_MASK         = 0x00FF0000; //0b0000_0000_1111_1111_0000_0000_0000_0000;
  private static final int MAJOR_VERSION_MASK = 0x0000FF00; //0b0000_0000_0000_0000_1111_1111_0000_0000;
  private static final int MINOR_VERSION_MASK = 0x000000FF; //0b0000_0000_0000_0000_0000_0000_1111_1111;
